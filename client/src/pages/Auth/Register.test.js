...
jest.mock("../../hooks/useCategory", () => jest.fn(() => [])); // Mock useCategory hook to return empty categories
...
describe("Register Component", () => {
  ...
  it("should display error message on registration with existing email", async () => {
